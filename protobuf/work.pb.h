...
PROTOBUF_NAMESPACE_OPEN
template <>
::prototask::FastResponse* Arena::CreateMaybeMessage<::prototask::FastResponse>(Arena*);
template <>
::prototask::RequestForFastResponse* Arena::CreateMaybeMessage<::prototask::RequestForFastResponse>(Arena*);
template <>
::prototask::RequestForSlowResponse* Arena::CreateMaybeMessage<::prototask::RequestForSlowResponse>(Arena*);
template <>
::prototask::SlowResponse* Arena::CreateMaybeMessage<::prototask::SlowResponse>(Arena*);
template <>
::prototask::WrapperMessage* Arena::CreateMaybeMessage<::prototask::WrapperMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class FastResponse final :
 ...
 public:
  ...
  void set_allocated_current_date_time(std::string* ptr);
...
inline PROTOBUF_ALWAYS_INLINE void FastResponse::set_current_date_time(Arg_&& arg,
                                                     Args_... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.current_date_time_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void FastResponse::set_allocated_current_date_time(std::string* value) {
  ...
  _impl_.current_date_time_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
